...
# MAGIC
# MAGIC For the sake of experimentation, let's implement a function that converts Fahrenheit to Celsius. Notice that we're inserting a one-second sleep to simulate a computationally expensive operation within out UDF. Let's try it.
...
# MAGIC %sql
# MAGIC explain SELECT farh_to_cels(temperature_F) as Farh_to_cels_convert FROM device_data
