...
# MAGIC [ADE 4.5L - Lab - Exploding Join]($./ADE 4.5L - Exploding Join) <br>
# MAGIC
# MAGIC #### Prerequisites
...
# MAGIC * All notebooks should be run with the following configuration (or with equivalent instance type):
# MAGIC ![Cluster Config](https://curriculum-dev.cloud.databricks.com/?o=3551974319838082#files/617694929921743)
